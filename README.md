...
**TKTK: Describe commencement here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/commencement/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|commencement|tweet|`location`||||
|commencement|facebook|`location`||||
|commencement|comments_opened|||||
|commencement|comments_closed||``seconds_open``|||
|commencement|comments_open_for|``seconds_open``|||
